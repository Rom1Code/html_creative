...
const card = document.querySelectorAll(".card");
  ...
  el.addEventListener("mousemove", (e) => {
    if(!isAnimationInProgress){
      ...
      el.children[2].style.background = `radial-gradient( farthest-corner circle at ${currentXGlare}% ${currentYGlare}%, hsla(0, 0%, 100%, 0.8) 10%, hsla(0, 0%, 100%, 0.65) 20%, hsla(0, 0%, 0%, 0.5) 90% )`
    }
  });
